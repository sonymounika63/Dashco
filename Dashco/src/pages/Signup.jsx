...
const Signup = () => {
  ...
  }, [formData, agreeToTerms, navigate]);
        ...
        <div className="max-w-[28rem] mx-auto w-full px-6 sm:px-8 pb-8">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5 mb-0 mt-8 w-full">
            ...
            >
              ...
              <span className="whitespace-nowrap">Sign up with Git</span>
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-0 mt-0">
            ...
            <div className="flex flex-row items-start justify-start mt-0 mb-3 w-full">
              <Checkbox
                id="agree-terms"
                name="agreeToTerms"
                label={
                  <>
                    ...
                    <Link
                      to="/terms"
                      className="text-[#465FFF] dark:text-[#465FFF] no-underline hover:text-[#3641F5]"
                    >
