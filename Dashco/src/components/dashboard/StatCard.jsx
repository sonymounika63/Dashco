...
const StatCard = ({ 
  ...
  if (useInfoBox2) {
    ...
    return (
      <div className="card bg-white dark:bg-white/[0.03] border-0 dark:border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm info-box-2 transition-colors duration-200">
        <div className="body">
          <div className="icon">
  ...
  return (
    <div className="card bg-white dark:bg-white/[0.03] border-0 dark:border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm overflow-hidden number-chart transition-colors duration-200">
      <div className="p-5">
        <div className="number">
          <h6 className="text-gray-900 dark:text-white/90 transition-colors duration-200 font-semibold">{heading}</h6>
          <span className="text-gray-900 dark:text-white/90 transition-colors duration-200 text-2xl font-bold">{value}</span>
        </div>
        <small className="text-gray-500 dark:text-gray-400 transition-colors duration-200">{perText}</small>
      </div>
      <div 
        ref={chartContainerRef}
        id={`main${index}`}
